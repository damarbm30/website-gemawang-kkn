...
const ItemKesenian = ({
  kesenian: { id, title, first, second, third, fourth, authorName, authorAvatar, createdAt, cover },
}) => {
  return (
    <div className="mx-4 flex w-[400px] flex-col rounded-2xl bg-white shadow-md transition-all hover:scale-105 md:mx-0">
      <Link to={`/kesenian/${id}`} className="text-inherit">
        <figure className="">
